...
const MoreThanMedicine = () => {
  return (
    <section className="">
      <Container>
        <section className="bg-purple-900 border border-purple-100 rounded-xl px-8 py-10 md:px-20 md:py-20">
          <article className="grid grid-cols-1 gap-10 md:gap-10 md:grid-cols-[min-content_1fr] items-center justify-center text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 h-full">
              <h3 className="text-5xl md:text-5xl font-light text-white">
                More&nbsp;than medicine
              </h3>

              <div className="h-[1px] md:h-full w-full md:w-[1px] bg-purple-800"></div>
            </div>

            <p className="font-light leading-8 text-purple-300">
